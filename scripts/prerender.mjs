  ...
  '/portfolio': {
    ...
    content: `      <main class="content-page"><div class="content-shell">
        <header class="content-header">
          ...
          <div class="content-lead"><p class="content-intro">Projects selected for depth, usefulness, and real-world use—not just recency.</p><nav class="content-nav"><a class="content-back-link" href="/">← Home</a></nav></div>
        </header>
        <section class="projects-grid" aria-label="Selected projects">
          <article class="project-card">
            <div class="project-card-head"><span class="project-category">Full-stack platform</span></div>
          ...
          <article class="project-card">
            <div class="project-card-head"><span class="project-category">Award-winning research project</span></div>
          ...
          <article class="project-card">
            <div class="project-card-head"><span class="project-category">Production workflow</span></div>
          ...
          <article class="project-card">
            <div class="project-card-head"><span class="project-category">Team hackathon build</span></div>
          ...
          <article class="project-card">
            <div class="project-card-head"><span class="project-category">Hardware + software</span></div>
          ...
          <article class="project-card">
            <div class="project-card-head"><span class="project-category">Everyday utility</span></div>
  ...
  '/media': {
    ...
    content: `      <main class="content-page"><div class="content-shell">
        <header class="content-header media-header">
          ...
          <div class="recognition-lines"><p><span class="recognition-year">2026</span><strong>Zen AI</strong><span class="recognition-detail">Regional winner · 2nd place Hessen · Informatics special prize</span></p><p><span class="recognition-year">2025</span><strong>Bloom Assist</strong><span class="recognition-detail">3rd place Hessen · two special prizes</span></p><p><span class="recognition-year">2024–26</span><strong>KiJuPa</strong><a class="recognition-detail recognition-link" href="https://www.heusenstamm.de/de/buerger-und-stadt/verwaltung-und-politik/kinder--und-jugendparlament">Elected to Heusenstamm’s first Kinder- und Jugendparlament</a></p></div>
        </header>
