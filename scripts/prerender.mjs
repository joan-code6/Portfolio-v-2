  ...
  '/portfolio': {
    ...
    content: `      <main class="content-page"><div class="content-shell">
        <header class="content-header">
          ...
          <div class="content-lead"><p class="content-intro">I selected these projects for their depth, usefulness, and real-world use, regardless of when I built them.</p><nav class="content-nav"><a class="content-back-link" href="/">Back home</a></nav></div>
        </header>
  ...
  '/media': {
    ...
    content: `      <main class="content-page"><div class="content-shell">
        <header class="content-header media-header">
          ...
          <div class="content-lead"><p class="content-intro">Independent reporting, school coverage, and official competition records about my Jugend forscht projects and awards.</p><nav class="content-nav"><a class="content-back-link" href="/">Back home</a></nav></div>
        ...
        <section class="media-archive" aria-label="Press articles and official records">
          ...
          <div class="media-grid">
            ...
            <a class="media-card" href="https://www.heusenstamm.de/Portals/0/Resources/6490/Downloads/Bg-Magazin-10-2024-final-web.pdf#page=5"><p class="media-meta"><span>City of Heusenstamm</span><time>October 2024</time></p><h3>Heusenstamms Jüngste engagieren sich für ihre Stadt</h3><p class="media-card-summary">The city’s municipal magazine documents the first KiJuPa’s formation and the role of its elected members in local decisions.</p><div class="media-card-footer"><span>Municipal magazine</span><strong>Open document</strong></div></a>
            <a class="media-card" href="https://www.op-online.de/region/heusenstamm/kinder-und-jugendparlament-wird-in-heusenstamm-gegruendet-93250702.html"><p class="media-meta"><span>Offenbach-Post</span><time>20 August 2024</time></p><h3>Kinder- und Jugendparlament wird in Heusenstamm gegründet</h3><p class="media-card-summary">The Offenbach-Post explains how Heusenstamm’s first elected youth parliament was created and which rights its members have in local politics.</p><div class="media-card-footer"><span>Local newspaper</span><strong>Read article</strong></div></a>
          </div>
        </section>
      </div></main>`,
  },
